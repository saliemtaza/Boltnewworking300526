...
import {
  X, Save, Eye, EyeOff, Check, ChevronUp, ChevronDown, Trash2, Plus,
  Package, ClipboardList, Truck, BarChart3, Settings, AlertTriangle, Flame,
  Copy, FileText, RefreshCw, ToggleLeft, ToggleRight, MessageCircle,
  Star, Search, Upload, ImageIcon, Tag, TrendingUp, TrendingDown, ShieldCheck
} from 'lucide-react';
